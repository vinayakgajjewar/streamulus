...
public:
    ...
    explicit Mavg(int decay_factor) : mFirst(true), mDecayFactor(decay_factor), mMavg(0), mPrevTime(0) {}
...
/*
 * Function object to remove consecutive repetitions from a stream. From what I
 * can understand, it returns boost::none if the provided value is a duplicate.
 */
template<typename T>
class unique {
public:
